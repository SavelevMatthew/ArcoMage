...
namespace ArcoMage.Cards
{
    public class CardDataBase
    {
        ...
        public static readonly List<Card> Deck = new List<Card>
        {
            ...
            new Card((p1, p2) => p1.Resources[Brick].AddResource(1, 0),
            ...
            new Card((p1, p2) => { p1.Resources[Brick].AddResource(1, 0); p1.Castle.AddWall(4); },
            ...
            new Card((p1, p2) => { p1.Resources[Animals].AddResource(1, 4); p2.Resources[Animals].AddResource(1, 0); },
            ...
            new Card((p1, p2) => p1.Resources[Brick].AddResource(2, 0),
                            GenerateCost(6), "+2 Mine"),
            new Card((p1, p2) => { p1.Castle.AddWall(5); p1.Resources[Animals].AddResource(1, 0); },
                             GenerateCost(9), "+6 Wall, +1 menagerie"),
            new Card((p1, p2) => { p1.Castle.AddWall(7); p1.Resources[Magic].AddResource(0, 7); },
